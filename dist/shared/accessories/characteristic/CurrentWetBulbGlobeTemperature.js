...
exports.configureCurrentWetBulbGlobeTemperature = configureCurrentWetBulbGlobeTemperature;
const SCHEMA_CODE = {
...
function configureCurrentWetBulbGlobeTemperature(accessory) {
    ...
    service.getCharacteristic(accessory.Characteristic.CurrentTemperature)
        ...
        const rh = accessory.getStatus(rhSchema.code)?.value || 1;
        const tSchema = accessory.getSchema(...SCHEMA_CODE.CURRENT_TEMP);
        const t = accessory.getStatus(tSchema.code)?.value || 1;
        const rhProperty = rhSchema?.property || {};
        const rhMultiple = Math.pow(10, rhProperty['scale'] || 0);
        const tProperty = rhSchema?.property || {};
...
//# sourceMappingURL=CurrentWetBulbGlobeTemperature.js.map