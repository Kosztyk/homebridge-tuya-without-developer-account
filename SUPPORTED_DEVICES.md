...
Fan speed note: discrete integer `fan_speed` ranges are exposed to HomeKit as 0-100% RotationSpeed. For example, a six-level `fan_speed` range maps levels 1..6 to approximately 17%, 33%, 50%, 67%, 83%, and 100%.
